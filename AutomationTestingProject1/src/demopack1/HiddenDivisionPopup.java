...
public class HiddenDivisionPopup 
{
	public static void main(String[] args) throws InterruptedException 
	{
		...
		ff.findElement(By.name("name")).sendKeys("random");
		
		ff.findElement(By.linkText("Completed Tasks")).click();
		
		String s= ff.findElement(By.id("DiscardChangesButton")).getAttribute("value");
		System.out.println(s);
		
		ff.findElement(By.id("DiscardChangesButton")).click();
